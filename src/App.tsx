...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] text-slate-800 font-sans selection:bg-blue-100 selection:text-blue-900 overflow-hidden flex flex-col">
      ...
      <div className="relative z-10 max-w-5xl mx-auto w-full px-3 md:px-10 pt-4 md:pt-8 flex flex-col h-[100dvh] overflow-hidden app-container">
        <header className="flex flex-col items-center mb-2 md:mb-4 shrink-0 app-header">
          <div className="text-center">
            ...
            <p className="text-[9px] md:text-[10px] text-blue-600 font-medium uppercase tracking-[0.15em] mt-0.5 leading-tight app-subtitle">Dein persönlicher Begleiter bei Ängsten, Depressionen, Psychosen</p>
          </div>
          <a href="tel:112" className="mt-2 bg-red-50 text-red-600 border border-red-100 px-3 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-wider hover:bg-red-100 transition-colors flex items-center gap-2 shadow-sm shrink-0 app-emergency">
        ...
        <footer className="shrink-0 flex flex-col justify-center items-center py-2 border-t border-slate-200/50 gap-0.5 app-footer">
